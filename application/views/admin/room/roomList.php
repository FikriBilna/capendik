        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/room/') ?>" id="roomform" name="roomform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php 
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="roomCode" name="roomcode" type="text" class="form-control" value="<?php echo set_value('room_code'); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="roomName" name="roomname" type="text" class="form-control" value="<?php echo set_value('room_name'); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="length" name="length" type="text" class="form-control" value="<?php echo set_value('length'); ?>" />
                                <span class="text-danger"><?php echo form_error('length'); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Width</label><small class="req">*</small>
                                <input autofocus="" id="width" name="width" type="text" class="form-control" value="<?php echo set_value('width'); ?>" />
                                <span class="text-danger"><?php echo form_error('width'); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Space Area</label><small class="req">*</small>
                                <input autofocus="" id="spaceArea" name="spacearea" type="text" class="form-control" value="<?php echo set_value('space_area'); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="capacity" name="capacity" type="text" class="form-control" value="<?php echo set_value('capacity'); ?>" />
