        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/weightage/') ?>" id="weightageform" name="weightageform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php 
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="weightageName" name="weightagename" type="text" class="form-control" value="<?php echo set_value('weightage_name'); ?>" />
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    ...
                                                    ?>
                                                            <a data-placement="left" href="<?php base_url(); ?>weightage/edit/<?php echo $wtg['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" ><i class="fa fa-pencil"></i></a>
                                                    <?php
                                                        }
