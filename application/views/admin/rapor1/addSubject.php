                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($this->rbac->hasPrivilege('rapor', 'can_edit')) { ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/rapor/add_weightage/<?php echo $raporSubject['id']; ?>?aksi=<?php echo $rapor_id; ?>&subject=<?= $raporSubject['subject_id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('add_weightage'); ?>"><i class="fa fa-plus"></i></a>
                                                <?php } ?>
