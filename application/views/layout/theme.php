...
if ($theme == "white") {
  ...
  ?>
  <link rel="stylesheet" href="<?php echo base_url(); ?>backend/dist/css/style-main.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>backend/dist/themes/purple/skins/skin-purple.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>backend/dist/themes/purple/ss-main-purple.css">
  <?php
}
