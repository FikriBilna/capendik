                            ...
                            <div class="box-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table" id="table">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="inputs[0][weightage_name]" placeholder="Enter your Name" class="form-control name_list" required="" />
                                            </td>
                                            <td>
                                                <input type="text" name="inputs[0][weightage]" placeholder="Enter your Name" class="form-control name_list" required="" />
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
